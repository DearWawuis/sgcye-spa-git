...
exports.signUp = exports.signToken = exports.signIn = void 0;
...
var signToken = exports.signToken = function signToken(user) {
  if (!SECRET) {
...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, lname, age, divisionName, email, password, rolesNames, foundDivision, foundRoles, newUser, saveUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          // Extraer datos del cuerpo de la petición
          _req$body = req.body, name = _req$body.name, lname = _req$body.lname, age = _req$body.age, divisionName = _req$body.divisionName, email = _req$body.email, password = _req$body.password, rolesNames = _req$body.rolesNames; // Verificar que la división existe y obtener su ID
          _context.next = 4;
          return _Divisions["default"].findOne({
            name: divisionName
          });
        case 4:
          foundDivision = _context.sent;
          if (foundDivision) {
            _context.next = 7;
            break;
          }
        ...
        case 9:
          ...
          return _context.abrupt("return", res.status(400).json({
            message: "Uno o más roles no encontrados"
          }));
        case 12:
          ...
          _context.t2 = lname;
          _context.t3 = age;
          _context.t4 = foundDivision._id;
          _context.t5 = email;
          _context.next = 20;
          return _Users["default"].encryptPassword(password);
        case 20:
          _context.t6 = _context.sent;
          _context.t7 = foundRoles.map(function (role) {
            return role._id;
          });
          _context.t8 = {
            name: _context.t1,
